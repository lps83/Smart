...
switch ($nbderoom){
	...
	case 2:
	$MyData->addPoints(array(intval($_GET['v00'],intval($_GET['v01'],intval($_GET['v02'],intval($_GET['v03'],intval($_GET['v04'],intval($_GET['v05'],"Room 2");
	$MyData->addPoints(array(intval($_GET['v10'],intval($_GET['v11'],intval($_GET['v12'],intval($_GET['v13'],intval($_GET['v14'],intval($_GET['v15'],"Room 3");
	break;
 ...
 $myPicture = new pImage(475,300,$MyData); 
