...
//         echo($ROOMID);
        ...
        $query = "INSERT INTO `ACURATORS` (ROOM_ID, ACURATOR_NAME, ACURATOR_TYPE, ACURATOR_DATA, ACURATOR_TIME ) VALUES ('$ROOMID', 'energ', 'energ', '$SENSOR_DATA', '$SENSOR_TIME')";
...
$i = 0 ;
				...
				while ($data_name = mysqli_fetch_array($req_name)){
					...
					$tab_id[$i] = $data_name['ROOM_ID'];
						...
						$query = "SELECT * FROM `ACURATORS` WHERE ROOM_ID=".$tab_id[$i]." and ACURATOR_NAME = 'energ' ORDER BY `ACURATOR_ID` DESC LIMIT 1"; 
