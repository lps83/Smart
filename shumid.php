...
//         echo($ROOMID);
        ...
        $query = "INSERT INTO `SENSORS` (ROOM_ID, SENSOR_NAME, SENSOR_TYPE, SENSOR_DATA, SENSOR_TIME ) VALUES ('$ROOMID', 'humid', 'humid', '$SENSOR_DATA', '$SENSOR_TIME')";
...
$i = 0 ;
				...
				while ($data_name = mysqli_fetch_array($req_name)){
					...
					$tab_id[$i] = $data_name['ROOM_ID'];
						...
						$query = "SELECT * FROM `SENSORS` WHERE ROOM_ID=".$tab_id[$i]." and SENSOR_NAME = 'humid' ORDER BY `SENSOR_TIME` DESC LIMIT 1"; 
